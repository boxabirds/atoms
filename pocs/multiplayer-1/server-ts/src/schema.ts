// Atoms multiplayer server — Schema
// Table definitions + re-exports from shared constants/machines.

import { schema, table, t } from 'spacetimedb/server';
import type { ReducerExport } from 'spacetimedb/server';

// Re-export shared constants and machines so index.ts has one import source
