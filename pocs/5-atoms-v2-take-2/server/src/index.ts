// Atoms v2 server — SpacetimeDB TypeScript module
...
function insertAtom(
  ...
  // For phaseOffset machines, stagger initial fire like level-1 does
...
export const init = spacetimedb.init((ctx) => {
  ...
  console.log(`Atoms v2 server initialized. Tick interval: ${TICK_INTERVAL_MICROS}us`);
});
